...
var style = [
	'.cm-wrap{padding:12px 14px 18px;display:flex;flex-direction:column;gap:12px}',
	'.cm-head{display:block}',
	'.cm-title{width:100%}',
	'.cm-title h2{display:block;width:100%;margin:0;font-size:20px;line-height:1.2;padding:12px 16px;background:#2a2d2e;border-radius:4px;box-sizing:border-box}',
	'.cm-panel{border:1px solid rgba(255,255,255,.12);border-radius:10px;overflow:hidden;background:rgba(255,255,255,.03)}',
...
function renderHeader() {
	return E('div', { 'class': 'cm-head' }, [
		E('div', { 'class': 'cm-title' }, [
			E('h2', {}, '\u5728\u7ebf\u8bbe\u5907')
		])
	]);
}
